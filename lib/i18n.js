...
const dict = {
  ...
  'list-title-mine': { zh: '当前会话的检查点（{{count}}）', en: 'This session’s checkpoints ({{count}})' },
  'list-title-all': { zh: '全部会话的检查点（{{count}}）', en: 'All sessions’ checkpoints ({{count}})' },
  'list-hint': { zh: '↑/↓ 选择 · r 恢复到此检查点 · a 当前/全部会话 · Esc 退出', en: '↑/↓ select · r restore to this checkpoint · a session/all · Esc quit' },
